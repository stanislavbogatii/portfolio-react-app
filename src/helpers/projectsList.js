...
const projects = [
    {
        title: "Weather App",
        description: "html/css, javaScript, React.js Geolocation api, Overpass api, Openweathermap api",
        img: weather_app,
    ...
    {
        title: "Marvel App",
        description: "html/css preprocessor sass, javaScript, React.js, used: Marvel api",
        img: marvel_app,
